...
- **结构化冷热怎么喂给系统**：KV 的冷热由**注意力稀疏**决定（H2O 的"重击者"、StreamingLLM 的"注意力汇"），这是比 LRU 精细得多的语义冷热。能不能把它接进 [A16a](A16a-LRU主动扫描.md) 的主动扫描 / [A16b](A16b-XVM-eBPF的LRU主动感知优化.md) 的可编程策略，让系统据"注意力冷热"治理 KV？目前空白。
...
| KV 冷热 → 主动扫描/可编程 | 注意力稀疏的结构化冷热喂给系统 | [A16a](A16a-LRU主动扫描.md)、[A16b](A16b-XVM-eBPF的LRU主动感知优化.md) |
