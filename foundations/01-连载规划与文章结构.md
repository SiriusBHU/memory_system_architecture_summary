...
advanced/                               ← A15 先进内存研究综述（开放连载）
  ...
  A16b-eBPF可编程回收策略-Android.md     （系统·冷热）
...
> 立场：A16 全 family 为**基于学界 + 第一性原理的设计探讨 / 可行性分析**，业界（Android / iOS / HarmonyOS）尚未落地这些方案；各篇严格区分「已有机制（事实）」与「本系列设想（标待核实）」，篇首均有「本篇立场」声明。

- [x] A16 总论 · Agent 时代内存负载 + 二维地图（[advanced/A16-前沿-Agent时代内存负载.md](../advanced/A16-前沿-Agent时代内存负载.md)）
- [x] A16a 系统·冷热 · LRU 主动扫描（[advanced/A16a-LRU主动扫描.md](../advanced/A16a-LRU主动扫描.md)）
- [x] A16b 系统·冷热 · eBPF 可编程回收策略：Android 学界研究与业界实践（[advanced/A16b-eBPF可编程回收策略-Android.md](../advanced/A16b-eBPF可编程回收策略-Android.md)）
- [x] A16c 系统·增长 · 异构压缩 CDSD（[advanced/A16c-异构压缩CDSD.md](../advanced/A16c-异构压缩CDSD.md)）
- [x] A16d 系统·增长 · 压缩 IP 边际建模（[advanced/A16d-压缩IP边际建模.md](../advanced/A16d-压缩IP边际建模.md)）
- [x] A16e 芯片·异构 · IOMMU 统一内存 + 异构 Page Fault / LRU（[advanced/A16e-IOMMU统一内存与异构PF-LRU.md](../advanced/A16e-IOMMU统一内存与异构PF-LRU.md)）
- [x] A16f 芯片+系统·异构+增长 · 端侧 KV Cache 管理方案（[advanced/A16f-端侧KV-Cache管理方案.md](../advanced/A16f-端侧KV-Cache管理方案.md)）
- [x] A16g 芯片·异构 · DRAM、PIM 异构协同管理（[advanced/A16g-DRAM-PIM异构协同管理.md](../advanced/A16g-DRAM-PIM异构协同管理.md)）
- [x] A16h 芯片·增长 · STT/SOT-MRAM 多级缓存方案（[advanced/A16h-STT-SOT-MRAM多级缓存方案.md](../advanced/A16h-STT-SOT-MRAM多级缓存方案.md)）
- [x] A16i 芯片·增长 · 端侧 UFS–HBF 增强（[advanced/A16i-端侧UFS-HBF增强.md](../advanced/A16i-端侧UFS-HBF增强.md)）
