...
| # | 主题 | 关键研究 / 出处 | 状态 |
|---|------|----------------|------|
| 1 | [SOT-MRAM：下一代缓存 SRAM 替代](sot-mram-cache-replacement-CN.md) | Nature Electronics, imec IEDM'23, VGSOT, npj Spintronics | ✅ 已完成 |
| 2 | [STT-MRAM 嵌入式商用化与 LLC 应用](stt-mram-embedded-llc-CN.md) | IBM/Samsung VLSI'24, IEDM'24, NXP/TSMC 16nm, Renesas ISSCC'24 | ✅ 已完成 |
| 3 | [新型嵌入式 NVM 生态 (ReRAM/RRAM)](emerging-envm-rram-CN.md) | TSMC 22/12nm ReRAM, Weebit ICCAD'24, Nordic/Infineon | ✅ 已完成 |
| 4 | [ECRAM 与 HfO2 铁电存储器件](ecram-fefet-ferroelectric-CN.md) | ACS Chem Rev, Adv Materials, HfO2 FeFET | ✅ 已完成 |
| 5 | [LPDDR6 标准与移动 DRAM 演进](lpddr6-standard-evolution-CN.md) | JEDEC JESD209-6, SK Hynix ISSCC'26, Samsung LPDDR6X | ✅ 已完成 |
| 6 | [UFS 5.0 与计算存储](ufs5-computational-storage-CN.md) | JEDEC JESD220H, Samsung UFS 5.0, M-PHY 6.0 | ✅ 已完成 |
| 7 | [HBM4/先进封装与 3D 集成](hbm4-advanced-packaging-CN.md) | TSMC SoIC (IEDM'24), HBM4E 3nm base, UCIe 3.0 | ✅ 已完成 |
| 8 | [混合 SRAM-MRAM 缓存层次架构](hybrid-sram-mram-cache-CN.md) | AIP Advances, imec SOT-MRAM, EADP 分析 | ✅ 已完成 |
